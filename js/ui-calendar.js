        ...
        <div class="cal-nav-actions">
          <div class="cal-export-dd">
            ...
            <div class="cal-export-menu" id="calExportMenu" role="menu">
              <div class="cal-export-menu-label">Export ${MONTHS[month]} ${year}</div>
              <button class="cal-export-item" onclick="exportCalendarRenewalsExcel();closeCalExportMenu()" role="menuitem">
