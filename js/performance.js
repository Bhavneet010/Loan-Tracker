...
window.shareDailySnapshotJpeg = async function () {
  ...
  try {
    ...
    const exportCss = `
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-brand-copy strong{font-size:32px;color:#120f28;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-tagline{font-size:11px;letter-spacing:0.12em;color:#5147a3;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-hero-row{gap:20px;margin-top:18px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-hero-title{font-size:40px;max-width:500px;line-height:0.96;color:#120f28;white-space:normal;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-hero-sub{margin-top:7px;font-size:17px;color:#3f3a66;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-hero-mtd{min-width:190px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-hero-mtd label{font-size:11px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-hero-mtd strong{font-size:34px;color:#120f28;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-hero-mtd span{font-size:14px;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-callout label{font-size:10px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-callout.primary label{font-size:10px;letter-spacing:0.07em;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-callout strong{font-size:23px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-callout.primary strong{font-size:29px;letter-spacing:0;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-callout span{font-size:13px;line-height:1.22;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-section-title span{font-size:11px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-card{padding:13px 14px;border-radius:16px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-kicker{font-size:10px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-head h4{font-size:21px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-list{margin-top:11px;gap:9px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-rank{min-width:31px;height:22px;font-size:11px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-name{font-size:16px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-metric,
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-metric.count{font-size:15px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-bar-track{height:7px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-leader-sub{font-size:12px;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-officer-id{width:42px;height:30px;font-size:13px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-officer-name{font-size:25px;color:#120f28;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-officer-hero-metric{min-width:140px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-officer-hero-metric strong{font-size:25px;color:#120f28;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-officer-hero-metric span{font-size:10px;}
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-subhead-row span,
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-subhead-row small{font-size:8px;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-renewal-metrics label{font-size:8px;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-renewal-metrics strong{font-size:18px;color:#120f28;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-renewal-metrics span{font-size:10px;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-renewal-bookmark span{font-size:10px;}
      ...
      .editorial-phone-report.snapshot-export.daily-jpeg-export .editorial-footer{padding:10px 26px 14px;font-size:10px;}
    `;
    exportHost.style.position = "fixed";
    exportHost.style.left = "-10000px";
    exportHost.style.top = "0";
